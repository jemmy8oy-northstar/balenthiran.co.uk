    ...
    return (
        <section id="strategy" className="container section-padding">
            <div className="glass" style={{
                padding: '64px',
                background: 'linear-gradient(225deg, rgba(99, 102, 241, 0.05) 0%, rgba(168, 85, 247, 0.05) 100%)',
            }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '48px' }}>
                    <div>
                        ...
                        <h2 style={{ fontSize: '2.5rem', marginTop: '16px', marginBottom: '24px' }}>Project Northstar</h2>
                        ...
                        <div style={{ display: 'flex', gap: '24px' }}>
                            <div className="glass" style={{ padding: '16px 24px', flex: 1 }}>
                                <div style={{ fontSize: '1.5rem', fontWeight: 800 }}>Oracle K8s</div>
                                <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>Cloud Infrastructure</div>
                            </div>
                            <div className="glass" style={{ padding: '16px 24px', flex: 1 }}>
                                <div style={{ fontSize: '1.5rem', fontWeight: 800 }}>Bi-Weekly</div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <h3 style={{ marginBottom: '32px', fontSize: '1.2rem' }}>Milestones to 100k Monthly Users</h3>
                            ...
                            {milestones.map((m, i) => (
                                <div key={i} style={{ textAlign: 'center', zIndex: 1, position: 'relative' }}>
                                    <div style={{
                                        ...
                                        height: '40px',
                                        borderRadius: '50%',
                                        background: m.active ? 'var(--accent-primary)' : 'var(--bg-dark)',
                                        border: '2px solid',
                                        borderColor: m.active ? 'var(--accent-primary)' : 'rgba(255,255,255,0.1)',
                                        margin: '0 auto 12px',
                                        display: 'flex',
                                        alignItems: 'center',
                                    ...
                                    <div style={{ fontWeight: 600, fontSize: '0.9rem' }}>{m.users}</div>
